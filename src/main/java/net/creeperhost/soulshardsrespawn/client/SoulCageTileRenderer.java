...
//    }
    ...
    @Override
    public void submit(SoulCageRenderState soulCageRenderState, PoseStack poseStack, SubmitNodeCollector submitNodeCollector, CameraRenderState cameraRenderState)
    {
