...
public class SoulShardsJeiPlugin implements IModPlugin
{
    ...
    {
        registration.addRecipeCatalyst(new ItemStack(RegistrarSoulShards.SOUL_SHARD), MultiblockCategory.SOUL_SHARD_CRAFTING);
    }
    ...
    public void registerRecipes(@NotNull IRecipeRegistration registration)
    {
        ...
        list.add(new MultiblockCategory.Recipe(new ItemStack(Items.DIAMOND), new ItemStack(RegistrarSoulShards.SOUL_SHARD)));
