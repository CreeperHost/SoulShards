...
public class RegistrarSoulShards {
    ...
    public static final RegistryObject<Item> VILE_SWORD = ITEMS.register("vile_sword", ItemVileSword::new);
    ...
    public static final RegistryObject<Item> SOUL_SHARD = ITEMS.register("soul_shard", ItemSoulShard::new);

    public static final RegistryObject<Block> SOUL_CAGE = BLOCKS.register("soul_cage", BlockSoulCage::new);
    ...
    public static final RegistryObject<BlockEntityType<TileEntitySoulCage>> SOUL_CAGE_TE = TILES_ENTITIES.register("soul_cage", () -> BlockEntityType.Builder.of(TileEntitySoulCage::new, SOUL_CAGE.get()).build(null));

    public static final RegistryObject<Enchantment> SOUL_STEALER = ENCHANTMENTS.register("soul_stealer", EnchantmentSoulStealer::new);
}
