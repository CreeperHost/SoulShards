...
//        registerServerProviders(event.getGenerator(), event.getLookupProvider(), event.getExistingFileHelper());
//    }

    @SubscribeEvent
    public static void gatherData(GatherDataEvent.Client event) {
        registerClientProviders(event.getGenerator(), event.getExistingFileHelper());
        registerServerProviders(event.getGenerator(), event.getLookupProvider(), event.getExistingFileHelper());
    }
