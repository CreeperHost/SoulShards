...
public class ItemModelGenerator extends ItemModelProvider
{
    ...
    public String getPath(RegistryObject<Item> item)
    {
        return ForgeRegistries.ITEMS.getKey(item.get()).getPath();
    }

    private void registerBlockModel(RegistryObject<Block> block, String path)
    {
        String registryPath = ForgeRegistries.BLOCKS.getKey(block.get()).getPath();
