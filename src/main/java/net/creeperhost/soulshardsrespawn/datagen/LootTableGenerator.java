...
public class LootTableGenerator extends LootTableProvider {
    ...
    public static class BlockLootTables extends BlockLoot {
        ...
        protected Iterable<Block> getKnownBlocks() {
            return ForgeRegistries.BLOCKS.getValues().stream().filter(block -> Objects.requireNonNull(ForgeRegistries.BLOCKS.getKey(block)).getNamespace().equals(SoulShards.MODID)).toList();
        }
    }
}
